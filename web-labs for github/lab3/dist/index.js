    ...
    borrowButtons.forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            if (!book.borrowerId) {
                ...
                renderBooks();
                renderUsers();
                showNotification("\u041A\u043D\u0438\u0433\u0430 \"".concat(book.title, "\" \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u043F\u043E\u0437\u0438\u0447\u0435\u043D\u0430 \u043A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447\u0435\u043C ").concat(user.name, "."), 'success');
            }
            else {
                ...
                renderBooks();
                renderUsers();
                showNotification("\u041A\u043D\u0438\u0433\u0430 \"".concat(book.title, "\" \u0443\u0441\u043F\u0456\u0448\u043D\u043E \u043F\u043E\u0432\u0435\u0440\u043D\u0443\u0442\u0430 \u043A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447\u0435\u043C ").concat(user.name, "."), 'success');
            }
        });
    });
}
